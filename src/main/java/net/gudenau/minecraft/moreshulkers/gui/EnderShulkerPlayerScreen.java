...
public class EnderShulkerPlayerScreen extends HandledScreen<EnderShulkerPlayerScreenHandler>{
    private static final Identifier TEXTURE = new Identifier(MOD_ID, "textures/gui/container/ender_shulker.png");
    private final PlayerEntity player;
    
    public EnderShulkerPlayerScreen(EnderShulkerPlayerScreenHandler handler, PlayerInventory inventory, Text title){
    ...
    public void tick(){
        ...
        if(stack.isEmpty() || stack.getItem() != MoreShulkers.Items.ENDER_SHULKER){
