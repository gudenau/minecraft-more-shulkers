...
public class LargeShulkerWorldScreenHandler extends ScreenHandler{
    private final Inventory inventory;
    
    public LargeShulkerWorldScreenHandler(int syncId, PlayerInventory playerInventory, Inventory inventory){
        super(MoreShulkers.Containers.LARGE_WORLD, syncId);
